...
def parse_arguments():
    ...
    parser.add_argument('--save_root', default="/home/cmz/experiments/ADNet-main/results_abd/train/fold0", type=str)
...
def main():
    ...
    milestones = [(ii + 1) * 1000 for ii in range(args.steps // 1000 - 1)]   # [1000, 2000, 3000 ... 50000]
